...
public class SwingClient {
	...
	public static void main(String[] args){
        ...
        try {
            ...
            //UIManager.setLookAndFeel("javax.swing.plaf.multi.MultiLookAndFeel");//Multiplexing LAF
...
//	}
	...
	private boolean validateTargetHostInfo2(String targetResource){
		if(!targetResource.startsWith("$"))return false;
		if(!targetResource.endsWith("$"))return false;
		if(targetResource.length() < 3)return false;
