...
if (_ie == true) {
  ...
  document.write('CODE="com.fortappend.batchuploadapplet.AppletClient.class" ');
  document.write('JAVA_CODEBASE="./" ');
  document.write('ARCHIVE="lib/BatchUploadApplet.jar" ');
  ...
  document.write('<APPLET CODE="com.fortappend.batchuploadapplet.ClientApplet.class" JAVA_CODEBASE="./" ARCHIVE="lib/BatchUploadApplet.jar" WIDTH="250" HEIGHT="250" NAME="fileupload">');
}
// BEGIN: Update parameters below for INTERNET EXPLORER, FIREFOX, SAFARI, OPERA, MOZILLA, NETSCAPE 6+ support.
document.writeln('<PARAM NAME=CODE VALUE="com.fortappend.batchuploadapplet.AppletClient.class">');
document.writeln('<PARAM NAME=CODEBASE VALUE="./">');
document.writeln('<PARAM NAME=ARCHIVE VALUE="lib/BatchUploadApplet.jar">');
